...
export const doctorsTable = pgTable("doctors", {
  ...
  availableFromWeekdays: integer("available_from_weekdays").notNull(), // 1
  availableToWeekdays: integer("available_to_weekdays").notNull(), // 5
  availableFromTime: time("available_from_time").notNull(),
  availableToTime: time("available_to_time").notNull(),
  speaciality: text("speaciality").notNull(),
